      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <Card>
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/payments" className="text-xs text-blue-400 hover:text-blue-300">View all →</Link>
          </div>
              ...
              {recentPayments.map((pay) => (
                <div key={pay.id} className="flex items-center justify-between py-2.5 border-b border-navy-700 last:border-0">
                  <div>
                    ...
                    <div className="text-xs text-navy-500">{pay.payment_method || "Manual"} · {new Date(pay.created_at).toLocaleDateString("en-IN")}</div>
                  </div>
