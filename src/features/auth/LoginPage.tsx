...
<<<<<<< HEAD
          <div className="mb-8">
            ...
            <p className="text-navy-500 text-sm">Sign in to your property dashboard</p>
          </div>
...
=======
          <h1 className="font-display text-5xl font-extrabold text-white leading-[1.1] mb-5">
            Every Property.<br />
            <span className="gradient-text">One Powerful</span><br />
            Platform.
          </h1>
          <p className="text-navy-400 text-lg max-w-sm leading-relaxed mb-12">
            Manage. Rent. Maintain. Grow. The complete property operating system built for modern India.
>>>>>>> bef539dc295540e41cafabd63812a8c0c0c348d5
          </p>

          <div className="grid grid-cols-2 gap-3 max-w-xs stagger-children">
            {[
      ...
      {/* Right — form */}
      <div className="flex-1 lg:max-w-[440px] flex flex-col justify-center px-8 py-12 animate-fade-in">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className={`w-full bg-navy-800/80 border ${fieldErrors.email ? "border-red-500" : "border-navy-600"} rounded-xl px-4 py-3 text-sm text-navy-100 placeholder-navy-600 focus:outline-none focus:ring-2 focus:ring-blue-electric focus:border-transparent transition-all`}
            />
            {fieldErrors.email && <p className="text-xs text-red-400 animate-fade-in-fast">{fieldErrors.email}</p>}
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full bg-navy-800/80 border ${fieldErrors.password ? "border-red-500" : "border-navy-600"} rounded-xl px-4 py-3 pr-11 text-sm text-navy-100 placeholder-navy-600 focus:outline-none focus:ring-2 focus:ring-blue-electric focus:border-transparent transition-all`}
              />
              <button
                type="button"
                onClick={() => setShowPass(!showPass)}
            ...
            {fieldErrors.password && <p className="text-xs text-red-400 animate-fade-in-fast">{fieldErrors.password}</p>}
          </div>
