...
export default function LoginPage() {
  ...
  //
  // Important:
  // We do NOT immediately navigate to /dashboard after a
  // successful password login.
  //
  // AppShell/useAuth will determine whether the profile is
  // complete and send the user to:
  //
  // /dashboard
  // OR
  // /onboarding
  ...
  async function handleSubmit(
    ...
    try {
      ...
      // Login succeeded.
      //
      // Keep the page from firing the "already logged in"
      ...
      /*
       * Give the auth state a moment to update, then let the
       * existing application routing determine the destination.
       *
       * Normally:
       *
      ...
      if (err instanceof Error) {
        ...
        if (
          ...
          setError(
            "Email confirmation is enabled in Supabase. Turn it off in Authentication settings."
          );
        } else if (
          message.includes(
            "phone not confirmed"
          ...
          setError(
            "Phone confirmation is enabled in Supabase. Turn it off in Authentication settings."
          );
        } else {
          setError(
            err.message
        ...
        <div className="flex-1 lg:max-w-[440px] bg-navy-950 flex flex-col justify-center px-8 py-12">
          ...
          <div className="mb-8">
            ...
            <p className="text-navy-500 text-sm">
              Sign in to your RENFLIX account
            </p>
          </div>
