...
export default function SignupPage() {
   ...
   * Important:
   *
   * Once signup succeeds, Supabase may immediately create the
   * session and update `user`.
   *
   * Without this flag, the effect below could redirect the user
   * to /dashboard before we redirect them to /onboarding.
   */
  const [
    redirectingToOnboarding,
    setRedirectingToOnboarding,
  ] = useState(false);
  ...
  async function handleSubmit(
    ...
    try {
      ...
      // Save signup origin.
      //
      // onboarding will use this to determine which identifier
      // is missing.
      // --------------------------------------------------------
      ...
      // CRITICAL:
      //
      // Prevent useAuth() from sending the user to dashboard
      // when Supabase creates the session after signup.
      // --------------------------------------------------------
      ...
      if (
         ...
         * Supabase should normally return a session.
         *
         * If there is no session, don't pretend that onboarding
         * can continue as an authenticated user.
         */
        if (!data.session) {
          throw new Error(
            "Account was created but no active session was returned. Make sure email confirmation is disabled in Supabase Authentication settings."
          );
        }
      }
      ...
      if (
        ...
        /*
         * With phone confirmation disabled,
         * Supabase should return a session immediately.
         */
        if (!data.session) {
          throw new Error(
            "Account was created but no active session was returned. Make sure phone confirmation is disabled in Supabase Authentication settings."
          );
        }
      }
      ...
      // --------------------------------------------------------
      // Give the success screen a short moment, then send the
      // newly-created account to onboarding.
      // --------------------------------------------------------
        ...
        <div className="hidden lg:flex flex-1 relative overflow-hidden bg-gradient-to-br from-blue-950 via-navy-900 to-navy-950 p-12">
          ...
          <div className="relative z-10 flex flex-col justify-center">
            ...
            <p className="text-navy-400 text-lg max-w-sm leading-relaxed mb-12">
              ...
              smarter – no spreadsheets, no chaos.
            </p>
        ...
        <div className="flex-1 lg:max-w-[440px] bg-navy-950 flex flex-col justify-center px-8 py-12">
          ...
          <div className="flex flex-col gap-3 mb-6">
            ...
            >
              ...
              >
                <path
                  fill="#4285F4"
                  d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57a10.12 10.12 0 0 0 3.37-6.22z"
                />

                <path
                  fill="#34A853"
                  d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.08 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"
                />
            ...
            >
              <svg
                ...
                fill="currentColor"
              >
                <path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.48-3.24 0-1.44.62-2.2.44-3.06-.4C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51-.06 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z" />
              </svg>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-navy-950 px-2 text-navy-500">
          ...
          >
            ...
            <div className="flex flex-col gap-1">
             ...
             {/* <p className="text-[11px] text-navy-600 mt-1">
                Use your email address or 10-digit Indian mobile number.
              </p>*/}
            </div>
            ...
            <button
              ...
              className="btn-primary w-full py-3.5 rounded-xl text-sm mt-1 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {submitting ? (
                <>
                  <svg
